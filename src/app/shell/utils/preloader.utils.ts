...
export const react19Preloader: Preloader = {
  name: 'react-19-preloader',
  relativeRemoteEntryUrl: 'pre_loaders/onecx-react-19-loader/mf-manifest.json',
  windowKey: 'react-19',
  exposedModule: 'React19Loader',
  shareScope: 'react_19'
}
