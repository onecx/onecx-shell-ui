...
**Examples:**
* Base URL: `https://myDomain.com/` → About page: `https://myDomain.com/onecx-shell/about-shell`
* Base URL: `https://myDomain.com/admin/portal/` → About page: `https://myDomain.com/admin/portal/onecx-shell/about-shell`
