...
import { AuthService, AuthServiceFactory, Injectables } from '@onecx/angular-auth'
import { KeycloakAuthService } from './adapters/keycloak-auth.service'
import './declarations'
import { DisabledAuthService } from './adapters/disabled-auth.service'
...
export class AuthServiceWrapper {
  ...
  constructor() {
    ...
    window.onecxAngularAuth = window.onecxAuth
  }
