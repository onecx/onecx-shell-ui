...
const webpackConfig = {
  ...withModuleFederationPlugin({
    ...
    shared: share({
      ...
      '@ngx-translate/core': { requiredVersion: 'auto', includeSecondaries: true, shareScope: 'angular_21' },
      '@ngx-translate/http-loader': { requiredVersion: 'auto', includeSecondaries: true, shareScope: 'angular_21' },
