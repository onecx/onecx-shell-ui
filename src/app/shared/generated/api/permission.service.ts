...
export class PermissionBffService {
  ...
  public getPermissions(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext }
  ): Observable<HttpResponse<GetPermissionsResponse>>;
  public getPermissions(
    getPermissionsRequest: GetPermissionsRequest,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext }
  ): Observable<HttpEvent<GetPermissionsResponse>>;
  public getPermissions(
    getPermissionsRequest: GetPermissionsRequest,
    observe: any = 'body',
    ...
    if (getPermissionsRequest === null || getPermissionsRequest === undefined) {
      throw new Error(
        'Required parameter getPermissionsRequest was null or undefined when calling getPermissions.'
      );
    }
    ...
    return this.httpClient.request<GetPermissionsResponse>(
      'post',
