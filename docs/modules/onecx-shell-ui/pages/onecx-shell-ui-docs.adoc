...
Overview of supported package versions in the shell across all environments.
...
It can be accessed by navigating to the route `/onecx-shell/about-shell` in your local application.
...
This will display a list of all Angular versions, that the shell is supporting, looking similar to the image below:
